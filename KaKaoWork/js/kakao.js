(function() {
    ...
    function scrollFun() {
        ...
        function scrollToDesc() {
            ...
            sectionDescElem.css("height", windowHeight * 2);
            ...
            if (initScrollTop < sectionDescElem.offset().top) {
                ...
                descEmphElem.css('top', (sectionDescElem.height() / 4) - 35); 
            ...
            } else if (initScrollTop > sectionDescTop && (scrollTop + windowHeight) <= sectionDescBottom) {
                ...
                var offSetTop = sectionDescBottom - (sectionDescTop + windowHeight);
                var descEmphElemTop = ((sectionDescElem.height() / 4) - 35) + offSetTop;
                var descImgElemTop = sectionDescElem.height() / 4 - 300 + offSetTop - 30;
